...
public class Controller implements Initializable {
    ...
    private void performDelete(ActionEvent event) {
        if (!TcdSelection.getInstance().isEmpty()) {
            ...
            if (confDlg.getResult() == ButtonType.YES) {
                TcdSelection.getInstance().deleteAll();
            }
        }
                ...
                curr.setOnDragDetected(new EventHandler<MouseEvent>() {
                    ...
                    public void handle(MouseEvent event) {
                        ...
                        if (source instanceof Button) {
                            ...
                            TcdControl newItem = TcdSelection.getInstance().generateNewItem(srcButton.getText(), basePane, true);
                    ...
                    public void handle(DragEvent event) {
                        ...
                        if (gestSrc != target && db.hasString()) {
                            ...
                            if (gestSrc instanceof TcdControl) {
                                ...
                                TcdSelection.getInstance().moveSelected(delta);
                            }
